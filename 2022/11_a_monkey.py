...
# you're going to have to focus on the two most active monkeys if you want any hope of getting your stuff back. Count the total number of times each monkey inspects items over 20 rounds:
...
for round_id in range(20):
    for monkey_id in monkey_ids:
        ...
        for worry in d[monkey_id]['startingitems']:
            worry = d[monkey_id]['operation'](worry)
            worry = math.floor(worry / 3)
            if worry % d[monkey_id]['divbyamount'] == 0:
                d[d[monkey_id]['throwtoiftrue']]['startingitems'].append(worry)
            else:
                d[d[monkey_id]['throwtoiffalse']
                  ]['startingitems'].append(worry)
